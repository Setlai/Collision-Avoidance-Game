...
public class GameLaunch extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        root.getChildren().addAll(military, clouds2, clouds3, clouds4, gmvrLabel);
    ...
    //Method to setting and positioning the clouds
    private ImageView createClouds(Scene scene){

        //setting the path and placements of clouds image
        ImageView clouds = new ImageView(new Image("Images/Clouds.png"));
        clouds.setFitHeight(150);
        clouds.setFitWidth(-150);


        //Setting the clouds motion
        TranslateTransition trans = new TranslateTransition();
        trans.setNode(clouds);
        trans.setDuration(Duration.millis(4000));
        trans.setCycleCount(TranslateTransition.INDEFINITE);
        trans.setFromX(1100 + 400);
        trans.setToX(-600);
        trans.setByX(200);
        trans.setByY(0);
        trans.setByX(scene.getWidth());
